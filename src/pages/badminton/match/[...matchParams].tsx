...
import BmtMatchDetails from '@/modules/badminton/matchDetails/pages';
import { formatTimestamp } from '@/utils';
import useTrans from '@/hooks/useTrans';
// import { SPORT } from '@/constant/common';
import { BadmintonLiveMatchesLoaderSection } from '@/components/modules/badminton/loaderData';
...
MatchDetailedPage.getInitialProps = async (
  ...
  const url = `${process.env.NEXT_PUBLIC_API_BASE_URL}/badminton/sport-event/${sportEventId}`;
  const config = {
    method: 'get',
