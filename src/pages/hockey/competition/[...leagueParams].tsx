...
import LeagueDetailedSubPage from '@/modules/hockey/competition/page';
...
LeagueDetailedPage.getInitialProps = async (
  ...
  const url = `${getAPIDetectedIP()}/hockey/unique-tournament/${competitionId}`;
  const config = {
    method: 'get',
  ...
  const urlSeason = `${getAPIDetectedIP()}/hockey/unique-tournament/${competitionId}/seasons`;
  const configSeason = {
    method: 'get',
    maxBodyLength: Infinity,
    url: urlSeason,
