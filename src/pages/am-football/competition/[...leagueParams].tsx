...
import LeagueDetailedSubPage from '@/modules/am-football/competition/page';
...
LeagueDetailedPage.getInitialProps = async (
  ...
  const url = `${getAPIDetectedIP()}/am-football/unique-tournament/${competitionId}`;
  const config = {
    method: 'get',
  ...
  const urlSeason = `${getAPIDetectedIP()}/am-football/unique-tournament/${competitionId}/seasons`;
  const configSeason = {
    method: 'get',
    maxBodyLength: Infinity,
    url: urlSeason,
