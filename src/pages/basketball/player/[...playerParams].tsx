    ...
    <>
      ...
      <div className='pb-8'>
        <div className='layout flex flex-col gap-6 lg:flex-row'>
          <div className='hidden w-[208px] lg:block sticky top-20 no-scrollbar lg:h-[91vh] lg:overflow-y-scroll'>
          ...
          <div className='flex-1'>
            ...
            {/* the list match */}
            <div className='w-full bg-white dark:bg-dark-card p-4 lg:rounded-lg'>
          ...
          <div className='w-full lg:w-[385px] sticky top-20 no-scrollbar lg:h-[91vh] lg:overflow-y-scroll'>
            <div className='w-full bg-white dark:bg-dark-card p-4 lg:rounded-lg'>
...
const TeamComponent = ({ teamName, teamId }: any) => (
  <div className='flex items-center gap-2 border-b border-underline-team dark:border-dark-time-tennis p-2'>
    <CustomLink
      href={`/basketball/competitor/${teamName}/${teamId}`}
      target='_parent'
    >
...
const PlayerRow = ({ player }: any) => {
  ...
  return (
    <div
      className='relative flex cursor-pointer items-center gap-2 border-b border-underline-team dark:border-dark-time-tennis p-2'
      onClick={() =>
...
const SummaryPlayerCard = ({ player, team }: any) => {
  ...
  return (
    <div className='mb-6 flex w-full flex-wrap overflow-hidden lg:rounded-lg dark-away-score lg:bg-transparent'>
      <div className='relative flex w-full items-center bg-line-default dark:bg-dark-stadium px-4 py-6 lg:w-1/2 lg:py-3'>
      ...
      <div className='grid w-full grid-cols-2 grid-rows-3 bg-line-default dark:bg-dark-summary lg:w-1/2'>
        ...
        <div className='col-span-2 row-start-3 h-[68px] px-4 py-3 border-l border-player-summary'>
          <h4 className='mb-[6px] text-[11px] text-light-secondary'>
            {i18n.qv.position}
          </h4>
          <div className='flex items-center gap-2'>
...
const LeagueHeader = ({ match }: any) => {
  ...
  return (
    <div className='mb-4 flex items-center gap-3'>
      ...
      <div>
        <h3 className='text-[11px] text-black dark:text-white'>{tournament?.name}</h3>
        {tournament?.country ? (
          <div className='flex gap-1'>
            <Avatar
      ...
      <div className='grid grid-cols-4 gap-3'>
        {staticArr.map((it: any) => (
          <div key={it} className='text-center'>
            <h4 className='mb-3 text-[10px] h-[22px] font-bold uppercase text-black dark:text-white'>
              {getTranslatedLabel(it, i18n)}
            </h4>
            <BoxStatsItem className='dark:border-linear-box flex flex-col justify-center bg-line-default dark:bg-primary-gradient'>
