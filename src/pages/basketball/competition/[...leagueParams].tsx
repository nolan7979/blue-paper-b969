...
import LeagueDetailedSubPageBkb from '@/modules/basketball/competition/page';
...
LeagueDetailedPage.getInitialProps = async (
  ...
  const url = `${getAPIDetectedIP()}/basketball/unique-tournament/${competitionId}`;
  const config = {
    method: 'get',
  ...
  const urlSeason = `${getAPIDetectedIP()}/basketball/unique-tournament/${competitionId}/seasons`;
  const configSeason = {
    method: 'get',
    maxBodyLength: Infinity,
    url: urlSeason,
