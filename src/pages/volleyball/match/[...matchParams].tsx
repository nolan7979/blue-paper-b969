...
import { LiveMatchesLoaderSection as VlbLiveMatchesLoaderSection } from '@/components/modules/volleyball/loaderData';

import { SportEventDtoWithStat } from '@/constant/interface';
import VlbMatchDetails from '@/modules/volleyball/matchDetails/pages';
  ...
  return (
    <div className='layout'>
      ...
      <VlbMatchDetails
        ...
        isDetails={true}
      />
      {/* <VlbLiveMatchesLoaderSection sport={SPORT.VOLLEYBALL} /> */}
    </div>
  );
};
MatchDetailedPage.getInitialProps = async (
  ...
  const url = `${process.env.NEXT_PUBLIC_API_BASE_URL}/volleyball/event/${sportEventId}`;
  const config = {
    method: 'get',
