...
import { LeagueRow } from '@/modules/basketball/competior/components';
import { SkeletonLeftSide } from '@/components/modules/basketball/skeletons';

export const AllLeague: React.FC<any> = ({ leagueData, idLeague, type, isLoading }: any) => {

  if (isLoading && leagueData && leagueData.length == 0) return <SkeletonLeftSide />;
