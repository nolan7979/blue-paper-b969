...
const Match = ({
  ...
  if (isLoading) {
    return (
      <div className='space-y-3'>
        ...
        <div className='space-y-3 bg-primary-gradient'>
  ...
  return (
    <div className='space-y-3'>
      ...
      <TwBorderLinearBox
        className={clsx(
          'dark:border-linear-box bg-white dark:bg-primary-gradient',
          {
            '!bg-none after:!bg-none': isDetail,
          }
        )}
      >
        <TabsSlider id='chart-tennis' center={true}>
          <div className='highlight-score-content p-8 px-6'>
            <div className='timeline-content'>
              <div className='team-content !pb-0'>
                <div className='home'>
                  <HandleGroupAvatar
              ...
              <div className='flex h-auto w-full items-center bg-bar-chart/[8%] dark:bg-[#171c29]'>
