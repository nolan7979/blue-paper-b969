...
export const DroppingOddsSummarySection = () => {
  return (
    <div className='h-36 bg-gradient-to-r from-blue-200 to-pink-100 py-2 dark:bg-dark-dark-blue dark:bg-none md:h-56'>
      <div>Menu</div>
      <div>Title</div>
    </div>
  );
...
export const MatchDetailSummarySection = ({
  ...
  return (
    <div className='dark:bg-dark-dark-blue'>
      <div className='hidden bg-gradient-to-r from-blue-200 to-pink-100 py-2 dark:bg-none lg:block'>
        <BreadCrumb className='layout'>
          <div className=' flex items-center gap-2 truncate text-xs font-extralight'>
            ...
            <BreadCumbLink
              href={`/competition/${tournament.slug}/${
                uniqueTournament?.id || tournament?.id
              }`}
          ...
          <BreadCrumbSep></BreadCrumbSep>
          <BreadCumbLink
            href={`/match/${matchData?.slug}/${matchData?.id}`}
...
export const PlayerLineUpSection = ({
  ...
  return (
    <div className='space-y-4'>
      <TwTitle className=''>{t('football:titles.lineups')}</TwTitle>
      ...
      {playerFilter === 'player-stats' && (
        <>
          <TwQuickViewSection className='h-96 p-4' />
        </>
      )}
    </div>
  );
