...
type MatchListHeader = {
  teamOrPlayer: 'team' | 'player';
}

export const MatchListHeader = ({ teamOrPlayer = "team" }: MatchListHeader) => {
    ...
    <div className='h-auto p-2 !px-0 text-csm dark:bg-dark-wrap-match md:px-2.5 dark:lg:bg-transparent'>
      <div className='flex items-center rounded-md md:px-2'>
        ...
        <div className='flex flex-1 gap-2 pl-2'>
          <div className='flex w-auto flex-col place-content-center items-center text-black dark:text-white capitalize'>
            {teamOrPlayer}
          </div>
