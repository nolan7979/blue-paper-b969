...
export const TopPlayerPerGameSection = ({
  ...
  if (isLoading || !data) {
    ...
    return (
      <div className='flex h-fit w-full  flex-col gap-3 rounded-lg bg-white dark:bg-dark-container px-2 py-8'>
...
export const StandingTypeFilterGroup = ({
  ...
  return (
    <div className='flex justify-between gap-x-2'>
      <div className='flex gap-3 bg-head-tab dark:bg-transparent dark:lg:bg-dark-head-tab rounded-full '>
