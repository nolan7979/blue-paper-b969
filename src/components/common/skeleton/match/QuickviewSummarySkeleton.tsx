...
const QuickviewSummarySkeleton: React.FC = () => {
  return (
    <div className='sticky top-20'>
      <div className='dark:bg-primary-gradient dark:border-linear-box rounded-md py-10'>
        ...
        <div className='flex items-center justify-between p-4 text-white'>
          ...
          <div>
            <Rectangle classes='h-10 w-10 xl:w-40' />
          </div>
          <div className='flex flex-col items-center justify-center gap-y-2'>
            <Circle classes='w-[56px] h-[56px]' />
            <Rectangle classes='h-3 w-10 xl:w-40' />
...
export default QuickviewSummarySkeleton;
