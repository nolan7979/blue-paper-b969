...
import { PenaltyShootoutSection } from '@/components/modules/snooker/match/PenaltyShootoutSection';
import AggregateScoreSection from '@/components/modules/snooker/quickviewColumn/quickviewDetailTab/AggregateScoreSection';
import MatchEventSection from '@/components/modules/snooker/quickviewColumn/quickviewDetailTab/MatchEventSection';
import MatchWinningOddsSection from '@/components/modules/snooker/quickviewColumn/quickviewDetailTab/MatchWinningOddsSection';
import PrematchStandingSection from '@/components/modules/snooker/quickviewColumn/quickviewDetailTab/PrematchStandingSection';
import RatingSection from '@/components/modules/snooker/quickviewColumn/quickviewDetailTab/RatingSection';
import RefereeSection from '@/components/modules/snooker/quickviewColumn/quickviewDetailTab/RefereeSection';
import QuickViewForm from '@/components/modules/snooker/quickviewColumn/QuickViewForm';
import { TwMbQuickViewWrapper } from '@/components/modules/snooker/quickviewColumn/quickViewMatchesTab';
import QuickViewPossessionRate from '@/components/modules/snooker/quickviewColumn/QuickViewPossessionRate';
import { WinRateSection } from '@/components/modules/snooker/quickviewColumn/QuickViewWinRate';
import { TwQuickViewTitleV2 } from '@/components/modules/snooker/tw-components';
import { TwQVDetailTabContainer } from '@/components/modules/snooker/tw-components/TwQuickview.module';

import { useOddsStore } from '@/stores';

import { SportEventDto, SportEventDtoWithStat } from '@/constant/interface';
import AttackMomentumSectionV2 from '@/modules/snooker/matchDetails/components/AttackMomentumSection';
...
import MatchRoundSection from '@/components/modules/snooker/quickviewColumn/quickviewDetailTab/MatchRoundSection';
  ...
  return (
    <div className='space-y-8  px-2.5 lg:px-0'>
      ...
      <TwQVDetailTabContainer className='space-y-8 pb-8'>
        ...
        <div className='space-y-6 lg:space-y-8 lg:px-0'>
...
export const VenueSection = ({
  ...
  return (
    <TwMbQuickViewWrapper>
      <TwQuickViewTitleV2>{i18n.match.matchInfo}</TwQuickViewTitleV2>
