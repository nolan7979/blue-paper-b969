          ...
          <>
            {groups?.map((groupData: any, index: number) => {
              ...
              const rowsNextMatch = rows?.map((item: any) => {
                ...
                return {
                  ...item,
                  nextMatchUrl: `/football/match/${nextMatch?.slug || 'slug'}/${nextMatch?.id}`,
                  nextTeam: nextMatch
              ...
              return (
                <React.Fragment key={`group-${index}`}>
                  <TwQuickViewSection className='overflow-x-auto z-0 scrollbar'>
                    ...
                    <ul className='w-fit space-y-1 text-xs'>
  ...
  return (
    ...
    >
      <CustomLink
        ...
        target='_parent'
        className={clsx('flex w-fit items-center', {
      ...
      >
        ...
        >
          <div
            test-id='team-logo'
            className={clsx('flex h-full items-center pl-1.5 bg-white dark:bg-transparent', {
              '!bg-logo-blue/20': team?.id === homeTeam?.id,
              '!bg-logo-yellow/20': team?.id === awayTeam?.id,
            })}
          >
        ...
        <div className='w-36 truncate whitespace-nowrap'>
          <SoccerTeam
            team={team}
            showIcon={false}
            teamPlaying={false}
...
const StandingCell = ({
  ...
  return (
    <div
      test-id='stading-col'
      className={`flex place-content-center dark:text-white items-center font-primary text-xss font-normal ${className}
      `}
      // css={[
      //   wide && tw`w-1/20`,
      //   !wide && tw`w-1/15`,
...
export const StandingHeaderRow = ({
  ...
  return (
    <li className='flex h-[2.375rem] w-fit items-center bg-head-tab dark:bg-dark-head-tab py-2.5 font-primary text-xss font-normal'>
      <div className='sticky left-0 z-[2] bg-head-tab dark:bg-dark-head-tab flex  pl-1.5'>
        {/* Rank */}
      ...
      <div className='w-12 text-center uppercase' test-id='col-qv-played'>
        {i18n.qv.played}
      </div>
      ...
      {showLong && (
        <>
          <div className='min-w-12 max-w-12  text-center uppercase text-standings-t'>
            {i18n.qv.won}
          </div>

          <div className='min-w-12 max-w-12  text-center uppercase text-standings-h'>
            {i18n.qv.drawn}
          </div>

          <div className='min-w-12 max-w-12  text-center uppercase text-standings-b'>
            {i18n.qv.lost}
          </div>
        </>
      )}
      ...
      {/* Points */}
      <div className='w-12 text-center normal-case'>{i18n.qv.pointsShort}</div>

      <div className='w-12 text-center uppercase'>{i18n.qv.goals_for}</div>

      <div className='w-12 text-center uppercase'>{i18n.qv.goals_against}</div>

      {/* nextFootballMatch*/}
      <div className='w-20 text-center normal-case'>
      ...
      <div className='flex w-full items-center justify-between gap-x-3 px-2 transition-all lg:px-0'>
        <div className='w-full space-y-5 whitespace-nowrap'>
          ...
          <div className='relative z-[4]'>
            <div
              className={clsx(
                'no-scrollbar flex h-[2.188rem] gap-2 overflow-x-auto',
                {
