...
const TeamH2HCommonEvents = dynamic(
  () => import('@/components/modules/hockey/teams/TeamH2HCommonEvents'),
  { ssr: false }
);
const TeamH2HEachTeamEvents = dynamic(
  () =>
    import('@/components/modules/hockey/teams/TeamH2HEachTeamEvents'),
  { ssr: false }
);
  ...
  return (
    <TwTabHead>
      ...
      >
        ...
        >
          <Avatar id={homeTeam?.id} type='team' height={24} width={24} isSmall rounded={false} isBackground={false} sport={SPORT.ICE_HOCKEY} />
        </button>
      </TwBorderLinearBox>
      <TwBorderLinearBox
      ...
      >
        ...
        >
          <Avatar id={awayTeam?.id} type='team' height={24} width={24} isSmall rounded={false} isBackground={false} sport={SPORT.ICE_HOCKEY} />
        </button>
      </TwBorderLinearBox>
    </TwTabHead>
  );
