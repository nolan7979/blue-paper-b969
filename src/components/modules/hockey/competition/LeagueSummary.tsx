...
export const LeagueSummary: React.FC<LeagueSummaryProps> = ({
  ...
  return (
    <div className='block lg:flex dark-away-score lg:bg-transparent lg:rounded-xl'>
      <div className='flex-1 bg-transparent lg:bg-white lg:dark:bg-dark-stadium px-3 py-4 lg:rounded-l-lg'>
      ...
      <div className='flex flex-1 flex-col justify-center gap-4 bg-transparent lg:bg-white lg:dark:bg-[#091550] px-3 py-4 lg:rounded-r-lg'>
        <CountrySeason
