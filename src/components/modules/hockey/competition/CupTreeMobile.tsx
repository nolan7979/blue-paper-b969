...
import { MatchItemCupTree } from '@/components/modules/hockey/competition/MatchItemCupTree';
      ...
      <div className=''>
        {isFinal && (
          <div className="flex items-center">
            <span className="z-[1] absolute right-0 -left-[10%] bottom-1/2 top-[47%]">
