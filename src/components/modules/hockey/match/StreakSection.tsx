...
import TeamStreakSection from '@/components/modules/hockey/teams/TeamStreakSection';
import H2HStreakSection from '@/components/modules/hockey/quickviewColumn/quickViewMatchesTab/H2HStreakSection';
import H2HBasketball from '@/components/modules/hockey/components/H2HBasketball';
