...
import { BadmintonCountryLeagueRows } from '@/components/modules/badminton/filters/BadmintonCountryLeagueRows';


export const BadmintonCategoryLeagues = ({
  cate,
  hrefPrefix,
}: {
  cate: any;
