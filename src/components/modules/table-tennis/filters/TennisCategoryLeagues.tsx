...
import { TennisCountryLeagueRows } from '@/components/modules/tennis/filters/TennisCountryLeagueRows';

import { SPORT } from '@/constant/common';
import { getImage, Images } from '@/utils';
import React from 'react';

export const TennisCategoryLeagues = ({
  cate,
  hrefPrefix,
}: {
  cate: any;
