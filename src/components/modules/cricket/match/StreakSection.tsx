...
import TeamStreakSection from '@/components/modules/cricket/teams/TeamStreakSection';
import H2HStreakSection from '@/components/modules/cricket/quickviewColumn/quickViewMatchesTab/H2HStreakSection';
