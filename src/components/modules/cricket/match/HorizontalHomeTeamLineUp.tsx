import { PlayerLineUp } from '@/components/modules/cricket/quickviewColumn/QuickViewSquadTab';
import { TwLineupVerticalLineAway } from '@/components/modules/cricket/tw-components';
