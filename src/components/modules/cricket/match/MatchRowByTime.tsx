...
import { OddsColumn } from '@/components/modules/cricket/match/MatchRow';
import {
  FirstColByTime,
  TwBellColByTime,
  TwCornerCol,
          ...
          <TwTeamNameCol className=''>
            <div className=' flex  gap-2'>
              <div className='min-w-8'>
                <CustomLink
                  href={`/cricket/competitor/${homeTeam.slug}/${homeTeam?.id}`} // TODO use slug
                  target='_parent'
                >
                  <Image
                    unoptimized={true}
            ...
            <div className=' flex  gap-2'>
              <CustomLink
                href={`/cricket/competitor/${awayTeam.name}/${awayTeam?.id}`} // TODO use slug
                target='_parent'
              >
                <Image
                  unoptimized={true}
