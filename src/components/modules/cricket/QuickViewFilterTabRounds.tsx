...
import { CupTreeMobile } from '@/components/modules/cricket/competition/CupTreeMobile';
import { RoundOf32 } from '@/components/modules/cricket/competition/rounds/RoundOf32';
...
const getRoundStages = (obj: ViewData | any, stages: string[] = []): string[] => {
  ...
  return (
    <Transition duration={0.5}>
      ...
      <div className='flex flex-col'>
        <div className="lg:no-scrollbar flex w-full gap-[8px] overflow-x-scroll dark:bg-dark-main p-4 pb-0">
