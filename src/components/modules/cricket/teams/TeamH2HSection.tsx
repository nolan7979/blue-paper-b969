import { useH2HData } from '@/hooks/useFootball';

import ConfrontationH from '@/components/common/skeleton/homePage/ConfrontationH';
import { InfoHomeAndAwayTeam } from '@/components/modules/cricket/quickviewColumn/QuickViewInfoHomeAndAwayTeam';
...
const TeamH2HSection = ({
  ...
  } = useH2HData(id, homeTeam?.id, awayTeam?.id, startTimestamp, SPORT.CRICKET);
