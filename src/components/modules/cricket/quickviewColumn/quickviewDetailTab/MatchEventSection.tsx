...
import { EventSeparator } from '@/components/modules/cricket/quickviewColumn/quickviewDetailTab/EventSeparator';
import TimeLineEventCardAway from '@/components/modules/cricket/quickviewColumn/quickviewDetailTab/TimeLineEventCardAway';
import TimeLineEventCardHome from '@/components/modules/cricket/quickviewColumn/quickviewDetailTab/TimeLineEventCardHome';
import TimeLineEventScoreAway from '@/components/modules/cricket/quickviewColumn/quickviewDetailTab/TimeLineEventScoreAway';
import TimeLineEventScoreHome from '@/components/modules/cricket/quickviewColumn/quickviewDetailTab/TimeLineEventScoreHome';
import TimeLineEventSubAway from '@/components/modules/cricket/quickviewColumn/quickviewDetailTab/TimeLineEventSubAway';
import TimeLineEventSubHome from '@/components/modules/cricket/quickviewColumn/quickviewDetailTab/TimeLineEventSubHome';
...
import { TwMbQuickViewWrapper } from '@/components/modules/cricket/quickviewColumn/quickViewMatchesTab';
import { TwTitle } from '@/components/modules/cricket/tw-components';

import { IdAndTimeLine, useTimeLineStore } from '@/stores/timeline-store';

import { formatTimestamp, isValEmpty } from '@/utils';
              ...
              data.timeline?.map((event: any, idx: number) => {
                if (
                  ...
                  return (
                    <div key={idx}>
                      {event.isHome ? (
                        <TimeLineEventVarHome key={idx} event={event} />
                      ) : (
                        <TimeLineEventVarAway key={idx} event={event} />
                      )}
                      <EventSeparator key={`s-${idx}`} />
                    </div>
                  );
