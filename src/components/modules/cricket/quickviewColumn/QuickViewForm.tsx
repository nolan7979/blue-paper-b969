  ...
  return (
    <div>
      ...
      <div className='space-y-4' test-id='form'>
        <FormSecion team={homeTeam} data={homeData} sport={sport} />
        <FormSecion team={awayTeam} data={awayData} sport={sport} />
      </div>
    </div>
  );
};
                  ...
                  >
                    <TwBorderLinearBox className='border-linear-form !rounded-full'>
                      ...
                      >
                        ...
                        <div>
                          <span
                            className='text-csm font-medium'
                            test-id='home-form-score'
                          >{`${item.homeScore?.display} - ${item.awayScore?.display}`}</span>
                        </div>
                        <Avatar
                          id={item.awayTeam.id}
                          type='team'
