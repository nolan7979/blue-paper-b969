...
export const SelectBXHFormat = () => {
  ...
  return (
    <Menu
      as='div'
      className='relative inline-block rounded-full hover:z-[5] dark:hover:brightness-150'
    >
      <div>
      ...
      >
        <Menu.Items
          ref={selectedRef}
          className={clsx(
            'absolute z-10 mt-2 w-32 origin-top-right rounded-md bg-white text-sm text-light-default shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-dark-head-tab dark:text-dark-text',
            {
