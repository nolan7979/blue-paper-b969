          ...
          <TwQuickViewSection className='!rounded-md p-2.5 text-center '>
            ...
            <div className=' mb-2 flex text-sm' test-id='pre-matching-team1'>
              ...
              <div className=' flex w-10 place-content-center items-center'>
                <CustomLink
                  href={`/football/competitor/${higerTeam.slug || higerTeam.name}/${
                    higerTeam?.id
                  }`}
                  target='_parent'
                >
            ...
            <div className=' flex text-sm' test-id='pre-matching-row2'>
              <div className=' flex w-6 items-center justify-center'>
                <span test-id='higher-pos2'>{lowerPosForm.position}</span>
              </div>
              <div className=' flex w-10 place-content-center items-center'>
                <CustomLink
                  href={`/football/competitor/${lowerTeam.slug || lowerTeam.name}/${
                    lowerTeam?.id
                  }`}
                  target='_parent'
                >
