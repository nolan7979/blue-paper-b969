...
export const WinRateSection: React.FC<WinRateSectionProps> = ({
    ...
    return (
      <div className='grid w-full grid-cols-3 gap-x-6'>
        <div
          ...
          className='col-span-1 flex flex-col items-center justify-center gap-y-2.5 rounded-l-md p-1 text-center text-csm text-black dark:text-white'
        >
          <span
            test-id='home-rate'
            className={clsx(
        ...
        <div className='col-span-1 flex flex-col items-center justify-center gap-y-2.5 p-1 text-center text-csm text-black dark:text-white'>
          <span
            test-id='draw-rate'
            className={clsx(
              'flex h-12 w-12 items-center justify-center p-1 text-clg',
          ...
          >{`${(values[1] > 0 && (100 - (getPercentage(values[0]) + getPercentage(values[2])))) || '0'}%`}</span>
          <span>{i18n.qv.draw}</span>
        </div>
        <div className='col-span-1 flex flex-col items-center justify-center gap-y-2.5 rounded-r-md p-1 text-center text-csm text-black dark:text-white'>
          <span
            test-id='away-rate'
            className={clsx(
              'flex h-12 w-12 items-center justify-center p-1 text-clg',
  ...
  return (
    <WrapperBorderLinearBox className=''>
      <TwMbQuickViewWrapper className='rounded-md !border-none p-3'>
        <div
...
export const SelectionButton: React.FC<ISelectionButton> = ({
  ...
  return (
    ...
    >
      <div className='dark:border-linear-rating border-linear-rating-light hover:cursor-pointer hover:brightness-150 rounded-md'>
        <div
