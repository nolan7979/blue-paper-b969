        ...
        <div className=''>
          <div className='flex flex-col'>
            ...
            >
              ...
              <div
                className='flex  justify-start font-semibold gap-y-1 text-mxs text-dark-text-full lg:text-xs'
...
export const QvPlayerReverse = ({
  ...
  return (
    <div className=' flex items-center justify-end gap-2'>
      <div test-id='player-shirtNo-name2' className=' text-end'>
        {rating > 0 && (
          <div className='h-6 w-fit'>
            <RatingBadge point={rating}></RatingBadge>
          </div>
        )}
        <p className='truncate whitespace-nowrap text-mxs text-dark-text-full lg:text-xs font-semibold'>
          {shirtNo > 0 ? `${shirtNo}`.padStart(2, '0') + ' - ' : ''}
          {name}
        </p>
      </div>
