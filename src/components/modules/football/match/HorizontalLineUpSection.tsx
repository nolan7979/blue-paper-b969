import { HorizontalHomeTeamLineUp } from '@/components/modules/football/match/HorizontalHomeTeamLineUp';
...
import TeamAwayLineUpHorizontal from '@/components/modules/football/teams/TeamAwayLineUpHorizontal';
