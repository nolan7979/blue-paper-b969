  ...
  return (
    <>
      ...
      <div className='flex max-h-[100vh] gap-x-3'>
        <div className='max-h-[100vh] space-y-6 w-1/2 flex-1 overflow-y-auto overflow-x-hidden scrollbar'>
        ...
        <div className={`no-scrollbar flex-1 overflow-auto ${showQuickView ? 'block' : 'hidden'}`}>
