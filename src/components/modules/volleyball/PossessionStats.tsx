      ...
      <div className='relative w-full overflow-hidden rounded-md border-2 border-white border-opacity-20'>
        ...
        <div className='relative'>
          <div className='flex h-64 w-full'>
            <div className='flex h-64 w-1/2 items-center justify-start border-r border-white border-opacity-20'>
            ...
            <div className='flex h-64 w-1/2 items-center justify-end border-l border-white border-opacity-20'>
              <div className='relative h-24 w-24 overflow-hidden'>
