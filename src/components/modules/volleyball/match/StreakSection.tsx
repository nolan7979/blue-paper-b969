...
export const StreakSection = ({ matchData }: { matchData: SportEventDto }) => {
  ...
  const { generalTotal, generalPerLastX, head2HeadTotal, head2HeadPerLastX } = data as ITeamStreaksData | any;
  ...
  return (
    <>
      ...
      {/* if h2hData */}
      <H2HBasketball head2head={h2hData} homeTeam={homeTeam} awayTeam={awayTeam} />
    </>
  );
};
