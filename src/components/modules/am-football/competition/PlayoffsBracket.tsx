...
const BracketPages = ({
  ...
  return (
    <div className='relative w-full lg:pt-10'>
      <div className='hidden lg:flex w-full px-4 absolute top-0 left-0 h-full z-[-1]'>
        {
      ...
      <div className='flex w-52 flex-col place-content-center items-center text-dark-text'>
        <div className='relative flex w-full place-content-center items-center'>
          ...
          <TwBlockContainer
            ...
            //     window.location.href = `/${SPORT.AMERICAN_FOOTBALL}/match/${getSlug(leftTeam?.name)}-${getSlug(rightTeam?.name)}/${events[0]}`;
            //   }
            // }}
          >
