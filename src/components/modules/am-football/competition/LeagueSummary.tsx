...
export const LeagueSummary: React.FC<LeagueSummaryProps> = ({
  ...
  return (
    <div className='dark-away-score grid grid-cols-1 lg:grid-cols-2 lg:rounded-xl lg:bg-transparent'>
      <div
        className={clsx(
          'bg-transparent px-3 lg:rounded-l-lg lg:bg-white lg:dark:bg-dark-stadium',
          { 'py-4': !isMobile }
        )}
      >
        ...
        <div>
          <div
            ...
            test-id='tournament-am-football-detail'
          >
            <Avatar
              id={uniqueTournament?.id}
              type='competition'
      ...
      <div
        className={clsx(
          'flex  flex-col justify-center gap-4 border-line-default bg-transparent px-3 py-4 dark:border-0 lg:rounded-r-lg lg:border-l lg:bg-white lg:dark:bg-[#091550]',
