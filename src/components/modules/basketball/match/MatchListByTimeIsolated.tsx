...
import { filterMatchesBasketball, formatMatchTimestamp, getDateFromTimestamp } from '@/utils';
import { convertStatusCode } from '@/utils/convertInterface';

import { MatchRowByTimeIsolated } from '@/components/modules/basketball/match';
              ...
              if (isSameDate) {
                ...
                return (
                  <div
                    key={match?.id || idx}
                  // ref={
                  //   idx === matchesToShow.length - 1 ? lastElementRef : null
                  // }
                  >
                    <div
                      key={`nd-${match?.id}`}
