    ...
    >
      <Listbox value={selected} onChange={setSelected}>
        <div className='relative rounded-lg bg-light-match dark:bg-dark-head-tab'>
          <Listbox.Button className=' relative flex w-full cursor-pointer items-center rounded-lg py-1 pr-3 text-left  dark:bg-dark-head-tab sm:text-sm'>
                    ...
                    <div className=' flex items-center gap-2 pl-4'>
                      ...
                      <TwTeamName>
                        <span className='min-w-0 truncate'>
                          ...
                          {/* {i18n.statsLabel[selected?.name] || 'Unknown'} */}
                        </span>
                      </TwTeamName>
                    </div>
                  )}
