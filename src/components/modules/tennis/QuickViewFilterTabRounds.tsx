  ...
  return (
    <Transition duration={0.5}>
      ...
      <div className='flex flex-col'>
        <div className="no-scrollbar flex w-full gap-[8px] overflow-x-scroll dark:bg-dark-main p-4 pb-0">
          {roundDescriptions.map((round, index) => (
            <button
              key={index}
              className={`px-4 py-2 rounded-full min-w-24 text-sm font-medium transition-all
                  ${activeTab === round
