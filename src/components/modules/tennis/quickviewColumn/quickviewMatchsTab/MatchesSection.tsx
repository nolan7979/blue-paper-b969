...
import { H2HFilter } from '@/components/modules/tennis/quickviewColumn/quickviewMatchsTab';
import { TeamH2HEachTeamEvents } from '@/components/modules/tennis/teams';
...
export const MatchesSection = ({
  ...
  return (
    <div
      className='space-y-4 px-2.5 pb-5 dark:bg-transparent lg:bg-transparent lg:px-0'
