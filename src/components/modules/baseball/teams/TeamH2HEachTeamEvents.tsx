...
import HeadMatchTitle from '@/components/modules/baseball/BkbHeadMatchTitle';
import MatchRowH2H from '@/components/modules/baseball/match/MatchRowH2H';
import { useEachTeamEventH2HDataBaseball } from '@/hooks/useBaseball';
...
const TeamH2HEachTeamEvents: React.FC<TeamH2HEachTeamEventsProps> = ({
  ...
  const {
    ...
    isLoading,
    error,
  } = useEachTeamEventH2HDataBaseball(teamIds); // not h2h
    ...
    <>
      ...
      <div className='flex max-h-[100vh] gap-x-3'>
        <div className='w-1/2 flex-1 overflow-y-auto scrollbar'>
          <HeadMatchTitle i18n={i18n} className='pr-12' />
