...
const BkbHeadMatchTitle: React.FC<{ i18n?: any; className?: string }> = ({
  i18n = vi,
  className,
}) => {
  return (
    ...
    >
      <div className='flex w-14 flex-col-reverse items-center justify-evenly md:flex-row lg:w-12'>
        <TwTitleHeader>{i18n.time.time}</TwTitleHeader>
      </div>
      <TwTeamScoreCol className='!pl-8'>
...
export default BkbHeadMatchTitle;
