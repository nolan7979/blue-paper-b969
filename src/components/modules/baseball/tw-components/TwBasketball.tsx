...
export const TwDataSection = tw.section`block md:flex gap-x-6 mt-0 md:mt-3`;
export const TwMatchDetailDataSection = tw.section`flex gap-x-4`;
export const TwFilterTitle = tw.h3`px-3 py-1 text-left  text-sm font-[700] uppercase leading-5 dark:text-white`;

export const TwFilterCol = tw.aside`
  shrink
  hidden
  gap-y-3
  lg:(flex flex-col)
...
export const TwMainCol = tw.section`
  flex-[5]
  lg:col-span-1
  md:flex-[4]
  lg:flex-[5]
...
export const TwMainColDetailPage = tw.section`
  flex-[8]
  lg:w-2/3
`;
...
export const TwQuickViewTitleV2 = tw.h5`pb-2 pt-5 lg:pt-3 font-bold text-sm uppercase text-center dark:text-white pl-4 lg:pl-0`;
...
export const TwQuickViewSection = tw.section`
  lg:rounded-md
  bg-white
  dark:bg-transparent
  border
...
export const TwSection = tw.section`
  rounded-md
  bg-light-match
  dark:bg-dark-match
  border
...
export const TwQuickViewTimeLine = tw.section`
  lg:rounded-md
  bg-white
  dark:bg-dark-match
...
export const TwFilterButton = ({
  ...
  <div
    ...
    css={[
      ...
      !isActive &&
        !disabled &&
        tw`dark:bg-dark-match bg-light-match dark:border-dark-button`,
      !isActive &&
        disabled &&
