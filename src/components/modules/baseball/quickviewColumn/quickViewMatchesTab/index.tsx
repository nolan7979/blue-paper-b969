...
const TeamH2HEachTeamEvents = dynamic(
  () => import('@/components/modules/baseball/teams/TeamH2HEachTeamEvents')
);
const TeamH2HCommonEvents = dynamic(
  () => import('@/components/modules/baseball/teams/TeamH2HCommonEvents')
);
...
//   const { error, isLoading } = useEachTeamEventH2HData(teamIds, SPORT.BASEBALL);
