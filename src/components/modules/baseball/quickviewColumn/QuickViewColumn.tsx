...
import QuickViewDetailTab from '@/components/modules/baseball/quickviewColumn/quickviewDetailTab';
...
import QuickViewStatsTab from '@/components/modules/baseball/quickviewColumn/QuickViewStatsTab';
import QuickViewSummary from '@/components/modules/baseball/quickviewColumn/QuickViewSummary';
import { QuickViewMatchesTab } from '@/components/modules/baseball/quickviewColumn/quickViewMatchesTab';
...
import { QuickViewFilter } from '@/modules/baseball/liveScore/components/QuickViewFilter';
...
export const QuickViewColumn = ({
  ...
  const { data } = useSelectedMatchBBData(
    ...
    <QuickviewColumnWrapper top={top} sticky={sticky} isDetail={isDetail}>
      <div className='h-full no-scrollbar lg:overflow-y-scroll'>
        ...
        <div className='space-y-4 '>
          ...
          {activeTab === 'chat' && (
            <QuickViewChatTab sport={SOCKET_CHAT_TOPIC.baseball} />
          )}
...
export const QuickViewColumn2nd = ({
  ...
  const { data, isLoading } = useSelectedMatchBBData(
    selectedMatch || '',
    15000,
    10000
  );
